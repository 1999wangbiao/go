...
type UserModel struct {
	...
	ArticleModel  []ArticleModel   `gorm:"foreignKey:UserID" json:"-"`                                                            // 发布文章列表
	CollectsModel []ArticleModel   `gorm:"many2many:user_collect_models;joinForeignKey:UserID;joinReferences:ArticleID" json:"-"` // 收藏文章列表
}
